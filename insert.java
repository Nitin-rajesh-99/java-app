...
public class insert extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {    
        ...
        String first_name= jTextField6.getText();
        String last_name= jTextField7.getText();
        String father_name= jTextField8.getText();
        String mothers_name= jTextField9.getText();
        String address= jTextField10.getText();
        String phno= jTextField14.getText();
        int ph=Integer.parseInt(phno);
        String mark1= jTextField12.getText();
        int m1=Integer.parseInt(id);
        String mark2= jTextField11.getText();
        int m2=Integer.parseInt(id);
        String mark3= jTextField13.getText();
        int m3=Integer.parseInt(id);
        String qry="insert into  `infotable` (id ,first_name,last_name ,father_name,mothers_name ,address ,phno,mark1,mark2 ,mark3) values("+idd+",'"+first_name+"','"+last_name+"','"+father_name+"','"+mothers_name+"','"+address+"',"+ph+","+m1+","+m2+","+m3+")";
        try{
